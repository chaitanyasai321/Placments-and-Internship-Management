...
<?php
	...
	$j_query= "SELECT * from company_details " ;
...
<?php
	...
	if(isset($_GET['idd1']))
	{
		...
		if(isset($_POST['ok']))
		{
				$query3=" DELETE FROM company_details WHERE idd='$cid1'  " ;
	...
	if(isset($_GET['idd2']))
	{
		...
		if(isset($_POST['upload']))
		{
		    ...
		    $C10=$_POST['c10'];
		   	...
		   	$C12=$_POST['c12'];
		   	$C13=$_POST['c13'];
			$C14 =addslashes(file_get_contents($_FILES["c14"]["tmp_name"])); 
			$C15=$_POST['c15'];
		    
		    $query5="SELECT * FROM company_details WHERE idd='$C1'" ;
		    ...
		    if($total5!=0)
		    {
		    	echo '<html><script> alert("Company Already Exist In ANITS Placements Please Recheck");</script></html>' ;
		    }
		    
		    else
		    {
			   	$query6="INSERT INTO `company_details` VALUES( '$C1' ,'$C2' ,'$C3' ,'$C4' ,'$C5' ,'$C6' ,'$C7' ,'$C8' ,'$C9' ,'$C10' ,'$C11' ,'$C12' ,'$C13' ,'$C14' ,'$C15' ) " ;
	...
	<div class="inside-box">
		...
		<div class="left-scroll">
			...
			<ul class="companies">
				<?php while($rowss= mysqli_fetch_array($data)) { ?>
					<a href="company.php?idd=<?php echo $rowss['idd']; ?>" >   <li> <?php echo $rowss['company']; ?> </li> </a> 
				<?php } ?>
		...
		<div class="header">
			<ul>
				...
				<li><a href="company.php?student=1"  >	 Student</a> </li>
				<li><a href="company.php?student1=1"  >	 Admin</a> </li>
				<li><a href="company.php?student2=1"  >	 Company</a> </li>
		...
		<div  class="mydiv" id="content">
			...
			<div class="add">
				...
				<label style="font-size:34px;color:ghostwhite;">Company Details</label>
				<a href='company.php?idd3=<?php echo 999; ?> ' name="addplacement"  value="Add New Placement" id="addplacement"  >
					<li>
						ADD Company Details
						...
						<tr>
						    ...
						    <td >
						    	<center>
						    		...
						    		<!--<a href='company.php?idd2=<?php echo $jrows['idd']; ?>' id="edit" name="edit" ><i class="fa fa-pencil" style="color:black;font-size:24px;"></i></a>--> 
						    		<a href='company.php?idd1=<?php echo $jrows['idd']; ?>' id="delete" name="delete" > <i class="fa fa-trash-o" style="font-size:24px;color:red"></i> </a>
						    	</center>
						    </td>
					   	</tr>
					   	<?php  }   
				...
				<div class="placement">
					...
					<form action="" method="POST" enctype="multipart/form-data" >
						<center>
							...
							<input type="button" name="back" id="back" value="Back" onclick="window.location.href='company.php'"><br>
						</center>	
					</form>
				</div>
			</center>
			...
			<div id="PLACED1" class="place1">	
				...
				<div class="placement1">
					...
					<form action="" method="POST" enctype="multipart/form-data" >
							...
							<div class="design"> <input type="text"  name="c1" placeholder="  ID" required ></div>
							<div class="design"> <input type="text"  name="c2" placeholder="  Company Name" required></div>
							<div class="design"> <input type="text"  name="c3" placeholder=" About Company" required></div>
							<div class="design"> <input type="text"  name="c4" placeholder=" Eligilibility" required></div>
							<div class="design"> <input type="text"  name="c5" placeholder="process" required></div>
							<div class="design"> <input type="text"  name="c6" placeholder="Task1" ></div>
							<div class="design"> <input type="text"  name="c7" placeholder="Task2" ></div>
							<div class="design"> <input type="text"  name="c8" placeholder="Task3" ></div>
							<div class="design"> <input type="text"  name="c9" placeholder="Task4" ></div>
							<div class="design"> <input type="text"  name="c10" placeholder="Task5" ></div>
							<div class="design"> <input type="text"  name="c11" placeholder="Task6" ></div>
							<div class="design"> <input type="text"  name="c12" placeholder="Technical" required ></div>
							<div class="design"> <input type="text"  name="c13" placeholder="HR" required ></div>
							<div class="design"> <input type="file"  name="c14" placeholder="Image" required ></div>
							<div class="design"> <input type="text"  name="c15" placeholder="link" required ></div><br>

							
							<input type="submit" name="upload1" id="upload1" value="Upload" >
							<input type="button" name="back" id="back1" value="Back" onclick="window.location.href='company.php'"><br>	
