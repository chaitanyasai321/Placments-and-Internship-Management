...
<?php
	...
	if(isset($_GET['idd1']))
	{
		...
		if(isset($_POST['ok']))
		{
				$query3=" DELETE FROM company WHERE cid='$cid1'  " ;
				$data3=mysqli_query($conn,$query3);
				header("location:placement_company.php");
		}
	}
?>
...
<?php
	...
	if(isset($_GET['idd2']))
	{
		...
		if(isset($_POST['upload']))
		{
		    ...
		    $query5="SELECT * FROM company WHERE cid='$cid1'   " ;
		    ...
		    else
		    {
			   	...
			   	$query6=" UPDATE `company` SET  `cname`='$Company1' , `crole`='$Role1' , `salary`='$salary'  WHERE cid='$cid1'  ";
	...
	if(isset($_GET['idd3']))
	{
		...
		if(isset($_POST['upload1']))
		{
		    ...
		    else
		    {
			   	...
			   	$query6="INSERT INTO `company`( `cid`, `cname`, `crole`, `salary` ) VALUES( '$cid1' , '$Company1' , '$Role1', '$year' ) " ;
		    	$data6=mysqli_query($conn,$query6);
		    	header("location:placement_company.php");
		   	}	 
		}	
	...
	<div class="inside-box">
		...
		<div class="left-scroll">
			...
			<ul class="companies">
				<?php while($rowss= mysqli_fetch_array($data)) { ?>
					<a href="placement_company.php?idd=<?php echo $rowss['idd']; ?>" >   <li> <?php echo $rowss['company']; ?> </li> </a> 
				<?php } ?>
		...
		<div class="header">
			<ul>
				...
				<li><a href="placement_company.php?student=1"  >	 Student</a> </li>
				<li><a href="placement_company.php?student1=1"  >	 Admin</a> </li>
				<li><a href="placement_company.php?student2=1"  >	 Company</a> </li>
		...
		<div  class="mydiv" id="content">
			...
			<div class="add">
				...
				<label style="font-size:34px;color:ghostwhite;">Companies</label>
				<a href='placement_company.php?idd3=<?php echo 999; ?> ' name="addplacement"  value="Add New Placement" id="addplacement"  >
					<li>
						ADD new Companies
						...
						<tr>
						    ...
						    <td >
						    	<center>
						    		...
						    		<a href='placement_company.php?idd2=<?php echo $jrows['cid']; ?>' id="edit" name="edit" ><i class="fa fa-pencil" style="color:black;font-size:24px;"></i></a> 
						    		<a href='placement_company.php?idd1=<?php echo $jrows['cid']; ?>' id="delete" name="delete" > <i class="fa fa-trash-o" style="font-size:24px;color:red"></i> </a>
						    	</center>
						    </td>
					   	</tr>
					   	<?php  }   
			...
			<div id="PLACED" class="place">	
				...
				<div class="placement">
					...
					<form action="" method="POST" enctype="multipart/form-data" >
						<center>
							<div class="design"> <input type="text" id="cid" name="cid" placeholder="  Company ID" required></div><br>
							<div class="design"> <input type="text" id="Company" name="company" placeholder="  Company Name" required></div><br>
							<div class="design"> <input type="text" id="Role" name="role" placeholder="   Role in Company / Course" required></div><br>
							<div class="design"> <input type="text" id="Year" name="salary" placeholder=" Salary" required></div><br>
							
							
							<input type="submit" name="upload" id="upload1" value="Edit" >
							<input type="button" name="back" id="back1" value="Back" onclick="window.location.href='placement_company.php'"><br>
						</center>	
					</form>
				</div>
			</center>
			...
			<div id="PLACED1" class="place1">	
				...
				<div class="placement1">
					...
					<form action="" method="POST" enctype="multipart/form-data" >
						<center>
							<div class="design"> <input type="text" id="cid1" name="cid1" placeholder="  Company ID" required></div><br>
							<div class="design"> <input type="text" id="Company1" name="Company1" placeholder="  Company Name" required></div><br>
							<div class="design"> <input type="text" id="Role1" name="Role1" placeholder="   Role in Company / Course" required></div><br>
							<div class="design"> <input type="text" id="Year1" name="Year1" placeholder=" Salary" required></div><br>
...
<script type="text/javascript">
	function cancel() {
  		...
  		window.location.href="placement_company.php";
	}
	function cancel1() {
