	...
	<div class="inside-box">
		...
		<div class="left-scroll">
			...
			<ul class="companies">
				<?php while($rowss= mysqli_fetch_array($data)) { ?>
					<a href="admin_account.php?idd=<?php echo $rowss['idd']; ?>" >   <li> <?php echo $rowss['company']; ?> </li> </a> 
				<?php } ?>
		...
		<div class="header">
			<ul>
				...
				<li><a href="admin_account.php?student=1"  >	 Student</a> </li>
				<li><a href="admin_account.php?student1=1"  >	 Admin</a> </li>
				<li><a href="admin_account.php?student2=1"  >	 Company</a> </li>
		...
		<div  class="mydiv" id="content">
			...
			<div class="add">
				...
				<label style="font-size:34px;color:ghostwhite;">Admin Records</label>
				<a href='admin_account.php?adding=<?php echo 999; ?> ' name="addplacement"  value="Add New Placement" id="addplacement"  >
					<li>
						ADD Admin Record
					...
					<?php
						...
						if($j_total!=0)
						{
							while($jrows=mysqli_fetch_array($j_data)) 
								{ if($jrows['role']=='student') continue; ?>
									<tr>
										<td >
											<center>
												<?php echo $jrows['sid']; ?>
									   ...
									   <td >
										    <center>
											    ...
											    <a href='admin_account.php?idd2=<?php echo $jrows['sid']; ?>' id="edit" name="edit" ><i class="fa fa-pencil" style="color:black;font-size:24px;"></i></a>
											    <a href='admin_account.php?delete=<?php echo $jrows['sid']; ?>' id="delete" name="delete" > <i class="fa fa-trash-o" style="font-size:24px;color:red"></i> </a>
										    </center>
									   </td>
								    </tr>
								<?php  }  
				...
				<center>
					<div class="placement">
						...
						<form action="" method="POST" enctype="multipart/form-data" >
							<div class="design" style="float:left;"> <input type="text" id="s_sid1" name="s_sid1" placeholder="Admin ID"  ></div>
							<div class="design" style="float:right;"> <input type="text" id="s_name1" name="s_name1" placeholder="Admin Name"  ></div><br><br>
							<div class="design" style="float:left;"> <input type="email" id="s_email1" name="s_email1" placeholder="Admin Mail" ></div>
							...
							<input type="button" name="back" id="back1" value="Back" onclick="window.location.href='admin_account.php'"><br>
						</form>
					</div>
				</center>
			</div>
			...
			<div id="PLACED1" class="place1">
				<center>
					<div class="placement1">
						...
						<form action="" method="POST" enctype="multipart/form-data" >
							<div class="design" style="float:left;"> <input type="text" id="s_sid" name="s_sid" placeholder="Admin ID"  required></div>
							<div class="design" style="float:right;"> <input type="text" id="s_name" name="s_name" placeholder="Admin Name"  required></div><br><br>
							<div class="design" style="float:left;"> <input type="email" id="s_email" name="s_email" placeholder="Admin Mail" required></div>
