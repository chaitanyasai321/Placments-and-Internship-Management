		...
		<div id="change" class="outer" >
			...
			<div class="inner">
				...
				<form method="POST"  action="">
					...
					<input type="button"  value="Back" onclick="window.location.href='user_home.php'"><br>
					<br>
				...
				<table>
					<tr>
						<td style="padding-right: 100px; padding-left: 100px;">
							<button id="placements" onclick="window.location.href='placements.php';"  >Placements</button>
						</td>
						<td style="padding-right: 100px; padding-left: 100px;">
							<button id="internship" onclick="window.location.href='internship.php'"  >Internship</button>
						</td>
					</tr>
				</table>
			</center>
