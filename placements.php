...
<?php
	...
	if(isset($_GET['idd2']))
	{
		...
		if(isset($_POST['upload']))
		{
		   ...
		   // else if($total7!=0)
		    //{
		    	//echo '<html><script> alert("This Records Already Exist");</script></html>' ;
		    //}
		    else
		    {
			    $cid= $row5['cid'];	
	...
	<div class="inside-box">
		...
		<div  class="mydiv" id="content">
			...
			<div class="add">
				...
				<label style="font-size:34px;color:ghostwhite;">Your Placement Records</label>
				<a href='placements.php?idd3=<?php echo 999; ?> ' name="addplacement"  value="Add New Placement" id="addplacement"  >
					<li>
						ADD new Placements
						...
						<tr>
						    ...
						    <td >
						    	<center>
						    		...
						    		<a href='placements.php?idd2=<?php echo $jrows['cid']; ?>' id="edit" name="edit" ><i class="fa fa-pencil" style="color:black;font-size:24px;"></i></a> 
						    		<a href='placements.php?idd1=<?php echo $jrows['cid']; ?>' id="delete" name="delete" > <i class="fa fa-trash-o" style="font-size:24px;color:red"></i> </a>
						    	</center>
						    </td>
					   	</tr>
					   	<?php  }   
				...
				<div class="placement">
					...
					<form action="" method="POST" enctype="multipart/form-data" >
						<center>
							...
							<input type="button" name="back" id="back" value="Back" onclick="window.location.href='placements.php'"><br>
						</center>	
					</form>
				</div>
			</center>
				...
				<div class="placement1">
					...
					<form action="" method="POST" enctype="multipart/form-data" >
						<center>
							...
							<input type="button" name="back" id="back1" value="Back" onclick="window.location.href='placements.php'"><br>	
						</center>
					</form>
				</div>
			    </center>
		...
		<div id="search_modal" class="search_modal">
			<div id="inside-modal">
				<div class="top-part">
					...
					<legend> <h2 style="font-size:30px;padding:0px 10px 0px 10px;"> Placement Results </h2> </legend>
					<form  method="POST"  action="" >
