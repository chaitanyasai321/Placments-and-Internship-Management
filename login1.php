<?php 
	...
	echo  "<html> <head> <style> .login-company{ display:none; }  </style> </head> </html>";
	if(isset($_GET['idd']))
  {
	$id=$_GET['idd'];
...
<?php
    ...
    // enable SMTP authentication
    		$mail->SMTPAuth = true;                  
    // GMAIL username
    		$mail->Username = "anitsplacementsinternships@gmail.com";
    // GMAIL password
    		$mail->Password = "anits@123";
    		$mail->SMTPSecure = "ssl";  
    // sets GMAIL as the SMTP server
    		$mail->Host = "smtp.gmail.com";
    // set the SMTP port for the GMAIL server
    		$mail->Port = "465";
    		$mail->From='anitsplacementsinternships@gmail.com';
    		$mail->FromName='Anits Placements and Internship';
    		$mail->AddAddress($sendmail, 'Reciever');
...
<body>
	...
	<div class="full-page">
		...
		<div class="results-tab">
			<h1 style="font-size:50px; bottom:30px"   > Top Placements </h1>
			<center> <table style="width:95%">
			<tr>
			<?php while($rowes=mysqli_fetch_array($j_data)) { ?>
			<td>
			<div class="picture">
		<div class="logo1"><?php echo'<img src="data:image;base64,'.base64_encode($rowes['photo']).'" height="90" width="90"   />'; ?></div>
		<br>
		<hr style="width:80%">
		<center>
		<label><?php echo $rowes['sname']; ?> </label><br>
		<label><?php echo $rowes['sid']; ?> </label><br>
		...
		<span>&#8377;</span>
		<label>    <?php echo $rowes['salary']." Lakh"; ?>  </label>
	</center>
		</div>
	   </td>
	    <?php } ?>
			...
			<div id="inside-modal">
				<div class="top-part">
					...
					<form  method="POST"  action="" >
						<center>
							<p> Search by Student ID or Student Name or Company Name or Company Role or Year or Branch  </p>
							<input type="text" name="submit_search" required id="submit_search1" >
		...
		<hr style="width:80%">
		<center>
		<label><?php echo $sea['sname']; ?> </label><br>
		<label><?php echo $sea['sid']; ?> </label><br>
		...
		<span>&#8377;</span>
		<label>    <?php echo $sea['salary']." Lakh"; ?>  </label>
	</center>
		</div>
	   </td>
	    <?php $i++; if($i==4){ echo '</tr><rr></tr>'; $i=0;}   }  ?>
	</tr>
	</table></center>
			</div>
			</div>
