...
<?php
	...
	$j_query= "SELECT * from company c inner join fake f on c.cid=f.cid and type='internship' " ;
...
<?php
	...
	if(isset($_GET['idd1']))
	{
		...
		if(isset($_POST['ok']))
		{
				$query3=" DELETE FROM fake WHERE cid='$cid1' and sid='$sid' and type='placements' " ;
...
<?php
	...
	if(isset($_GET['idd2']))
	{
		...
		if(isset($_POST['upload']))
		{
		    ...
		    $query5="SELECT * FROM company WHERE cname='$Company1' and crole='$Role1'  " ;
		    $data5=mysqli_query($conn,$query5);
		    $row5= mysqli_fetch_array($data5);
		    $total5=mysqli_num_rows($data5);

		    $query7=" SELECT * FROM fake WHERE cid='$cid1' and sid='$sid' and type='placements' " ;
	...
	<div class="inside-box">
		...
		<div  class="mydiv" id="content">
			...
			<div class="add">
				...
				<label style="font-size:34px;color:ghostwhite;">Your Intership Records</label>
				<a href='student_internship.php?idd3=<?php echo 999; ?> ' name="addplacement"  value="Add New Placement" id="addplacement"  >
					<li>
						ADD new Internship
						...
						<tr>
						    ...
						    <td >
						    	<center>
						    		...
						    		<a href='student_internship.php?idd2=<?php echo $jrows['cid']; ?>' id="edit" name="edit" ><i class="fa fa-pencil" style="color:black;font-size:24px;"></i></a> 
						    		<a href='student_internship.php?idd1=<?php echo $jrows['cid']; ?>' id="delete" name="delete" > <i class="fa fa-trash-o" style="font-size:24px;color:red"></i> </a>
						    	</center>
						    </td>
					   	</tr>
					   	<?php  }   
				...
				<div class="placement">
					...
					<form action="" method="POST" enctype="multipart/form-data" >
						<center>
							...
							<div class="design"> <input type="text" id="Company" name="Company" placeholder="  Company Name" required> </div>
				...
				<div class="placement1">
					...
					<form action="" method="POST" enctype="multipart/form-data" >
						<center>
							...
							<div class="design"> <input type="text" id="Company1" name="Company1" placeholder="  Company Name" required></div>
                 ...
                 <option value="other" > Other </option>
							...
							<b>Placement Letter	</b>
							<input type="file" id="document1" name="document1" required><br>
...
<script type="text/javascript">
	function cancel() {
  		...
  		window.location.href="student_internship.php";
	}
	function cancel1() {
